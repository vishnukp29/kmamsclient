...
const navigation = [
  ...
  { name: "Retailors", href: "/retailors", current: false },
  { name: "All Shops", href: "/all-shops", current: false },
  // { name: "Missing Phones", href: "/dashboard", current: false },
  // { name: "Notifications", href: "/dashboard", current: false },
];
                ...
                <div className="flex-shrink-0 ml-2">
                  ...
                  >
                    <LogoutIcon
                      ...
                      aria-hidden="true"
                    />
                    <span className="text-lime-300">Logout</span>
                  </button>
                </div>
          ...
          <Disclosure.Panel className="md:hidden">
            ...
            <div className="pt-4 pb-3 border-t border-gray-700">
              <div className="flex items-center px-5 sm:px-6">
                ...
                <div className="ml-3">
                  <div className="text-base font-medium text-lime-400">
              ...
              <div className="mt-3 px-2 space-y-1 sm:px-3">
                {userNavigation.map(item => (
                  <a
                    key={item.name}
                    href={item.href}
                    className="block px-3 py-2 rounded-md text-base font-medium text-lime-400 hover:text-yellow-300 hover:bg-gray-700"
                  >
                    {item.name}
                  </a>
                ))}
