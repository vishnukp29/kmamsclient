          ...
          {loading ? (
            ...
            <div class="lg:w-4/5 mx-auto flex flex-wrap p-10 border border-sm rounded-md ">
              ...
              <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div class="flex justify-center mb-4 lg:h-64">
                    <img
                    alt="ecommerce"
                    class="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200"
                ...
                <div class="flex">
                  {isCreatedBy ? (
                    <p class="flex mx-auto justify-between">
                      <Link
                    ...
                    <div className="space-x-8 flex justify-center mt-32 md:mt-0 ">
                      <Link
                        to={`/all-shops`}
                        className="text-gray-700 py-2 px-4 uppercase rounded bg-lime-400 hover:bg-lime-500 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5"
                      >
                        {" "}
                        Approve
                      </Link>
