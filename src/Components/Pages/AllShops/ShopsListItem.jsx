        ...
        <div className="flex flex-wrap items-center justify-center ">
          ...
          <div className="w-full flex lg:w-4/12 px-4  mb-6 lg:mb-0 justify-between">
            ...
            <Link
              ...
              className=" inline-block py-1 px-2 mr-2 mb-1 lg:mb-0 text-base rounded bg-lime-400 text-bold hover:bg-lime-500 text-slate-800 font-medium drop-shadow-md"
             >
              View Shop
            </Link>
          </div>
